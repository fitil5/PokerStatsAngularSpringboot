...
var routes = [
    ...
    {
        path: 'pm',
        component: pm_component_1.PmComponent
    },
    {
        path: 'admin',
    ...
    {
        path: 'administracion',
        component: administracion_component_1.AdministracionComponent
    }, {
        path: 'editUsuario',
        component: edit_usuario_component_1.EditUsuarioComponent
    },
    {
        path: '',
